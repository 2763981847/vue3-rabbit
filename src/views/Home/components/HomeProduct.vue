...
import {listGoods} from "@/apis/home";
import {onMounted, ref} from "vue";
import GoodItem from "@/views/Home/components/GoodItem.vue";

const goodList = ref<Category[]>([])
const refreshGoodList = async () => {
  goodList.value = (await listGoods()).result
}
...
<template>
  <div class="home-product">
    <HomePanel :title="category.name" v-for="category in goodList" :key="category.id">
      <div class="box">
